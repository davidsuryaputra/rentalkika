...
<?php $__env->startSection('content'); ?>
  ...
  <section class="content">
    <div class="row">
          <div class="col-xs-12">
            <form method="post" action="<?php echo e(route('admin.pricings.sewa_update', $harga_sewa->id)); ?>">
              ...
              <div class="box-body">
				...
				<div class="form-group <?php echo e($errors->has('zone_name') ? 'has-error' : ''); ?>">
					...
					<select name="zone_name" class="form-control zone" style="width: 100%">
						...
						<?php if($zone->id == $harga_sewa->zone_id): ?>					
				...
				<div class="form-group <?php echo e($errors->has('car_class') ? 'has-error' : ''); ?>">
					...
					<?php if($car_class->id == $harga_sewa->car_class_id): ?>
					<option value="<?php echo e($car_class->id); ?>" selected><?php echo e($car_class->name); ?></option>
					<?php else: ?>
				...
				<div class="form-group <?php echo e($errors->has('keterangan') ? 'has-error' : ''); ?>">
					...
					<option value="sopir" <?php echo e($harga_sewa->keterangan == 'sopir' ? 'selected' : ''); ?>>Tarif sopir per jam</option>
					<option value="luar kota" <?php echo e($harga_sewa->keterangan == 'luar kota' ? 'selected' : ''); ?>>Tarif luar kota per jam</option>
					<option value="overtime" <?php echo e($harga_sewa->keterangan == 'overtime' ? 'selected' : ''); ?>>Tarif overtime per jam</option>
					<option value="dasar" <?php echo e($harga_sewa->keterangan == 'dasar' ? 'selected' : ''); ?>>Tarif dasar per 14 jam</option>
					</select>
				</div>				
				
				<div class="form-group <?php echo e($errors->has('value') ? 'has-error' : ''); ?>">
					<label>Harga</label>
					<input type="text" class="form-control" value="<?php echo e($harga_sewa->value); ?>" name="value">
