...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo e(url('assets/ico/favicon.ico')); ?>">

    <title>Rental Kika</title>
  ...
  <body>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="<?php echo e(route('customer.order_rental')); ?>">SEWA</a></li>
                <li><a href="<?php echo e(route('customer.order_antar_jemput')); ?>">ANTAR JEMPUT</a></li>
	...
	<script src="<?php echo e(url('assets/js/retina-1.1.0.js')); ?>"></script>
	<script src="<?php echo e(url('assets/js/jquery.hoverdir.js')); ?>"></script>
	<script src="<?php echo e(url('assets/js/jquery.hoverex.min.js')); ?>"></script>
	<script src="<?php echo e(url('assets/js/jquery.prettyPhoto.js')); ?>"></script>
  	<script src="<?php echo e(url('assets/js/jquery.isotope.min.js')); ?>"></script>
