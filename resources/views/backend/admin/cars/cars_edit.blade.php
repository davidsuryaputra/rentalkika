  ...
  <section class="content">
    <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title">Ubah Mobil</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <form role="form" action="{{ route('admin.cars.update', $car->id) }}" method="POST">
              {{ csrf_field() }}
              <!-- text input -->
              ...
              <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input class="form-control" placeholder="Kijang Innova ..." value="{{ $car->name }}" name="car_name" type="text">
